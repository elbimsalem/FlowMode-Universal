...
struct ThemeProvider {
    static let defaultThemes: [Theme] = [
        Theme(
            ...
            ringBackgroundColor: CodableColor(semantic: .secondaryOpacity03),
            primaryTextColor: CodableColor(semantic: .primary),
            secondaryTextColor: CodableColor(semantic: .secondary),
            backgroundColor: CodableColor(semantic: .systemBackground),
        ...
        Theme(
            ...
            name: "Minimal",
            isPremium: false,
            primaryRingColor: CodableColor(semantic: .primary),
            secondaryRingColor: CodableColor(semantic: .primaryOpacity06),
            ringBackgroundColor: CodableColor(semantic: .primaryOpacity01),
            primaryTextColor: CodableColor(semantic: .primary),
            secondaryTextColor: CodableColor(semantic: .secondary),
            backgroundColor: CodableColor(semantic: .systemBackground),
            useGradientBackground: false,
